...
process.schedule = cms.Schedule(process.EcalEBtp_step,process.hgcl1tpg_step,process.L1simulation_step,process.L1TrackTrigger_step,process.MTD_step,process.endjob_step,process.FEVTDEBUGHLToutput_step)
